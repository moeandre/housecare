...
public class LotacaoPK implements Serializable {
	...
	@Column(name = "id_leito", insertable = false, updatable = false, unique = true, nullable = false)
	private int idLeito;

	@Column(name = "id_quarto", insertable = false, updatable = false, unique = true, nullable = false)
	...
	public void setIdLeito(final int idLeito) {
	...
	public boolean equals(final Object other) {
		...
		final LotacaoPK castOther = (LotacaoPK) other;
		return (this.idLeito == castOther.idLeito) && (this.idQuarto == castOther.idQuarto) && (this.idCliente == castOther.idCliente)
