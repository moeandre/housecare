...
(function() {
    ...
    function routesConfig($httpProvider, $stateProvider, $locationProvider, $urlRouterProvider, helper){
        ...
        $stateProvider
          ...
          .state('cliente.dadocadastral', {
              url: '/dadocadastral',
              title: 'Dados Cadastrais',
              templateUrl: helper.basepath('cliente/lista.html')
          })
          .state('cliente.criarCliente', {
              url: '/dadocadastral/criar',
              title: 'Dados Cadastrais - Criar Cliente',
              templateUrl: helper.basepath('cliente/formulario.html')
          })
          .state('cliente.editarCliente', {
              url: '/dadocadastral/editar/:id',
              title: 'Dados Cadastrais - Editar Cliente',
              templateUrl: helper.basepath('cliente/formulario.html')
          })
          .state('cliente.hospedagem', {
              url: '/hospedagem',
              title: 'Hospedagem',
              //templateUrl: helper.basepath('portlets.html'),
              //resolve: helper.resolveFor('ui.sortable')
          ...
          .state('configuracao.criarEmpresa', {
              url: '/empresa/criar',
              title: 'Criar Empresa',
              templateUrl: helper.basepath('empresa/formulario.html')
          })
          .state('configuracao.editarEmpresa', {
