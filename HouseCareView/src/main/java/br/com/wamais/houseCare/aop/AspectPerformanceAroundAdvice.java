...
//	@Around("execution(* br.com.wamais.houseCare.repository..*Repository.*(..))")
...
//	}
//
//	@Around("execution(* br.com.wamais.houseCare.controller..*Controller.*(..))")
...
//	}
//
//	@Around("execution(* br.com.wamais.houseCare.service..*Service.*(..))")
...
//	}
	...
	@Around("@annotation(br.com.wamais.houseCare.annotation.MeasureExecutionTime)")
	// Quem esta anotado
