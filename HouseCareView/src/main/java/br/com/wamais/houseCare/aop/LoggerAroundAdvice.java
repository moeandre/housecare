...
public class LoggerAroundAdvice {
	 ...
	 */
	@AfterThrowing(pointcut = "execution(* br.com.wamais.houseCare.service..*Service.*(..))", throwing = "e")
	 ...
	 * Called between the throw and the catch
	 */
	@AfterThrowing(pointcut = "execution(* br.com.wamais.houseCare.repository..*Repository.*(..))", throwing = "e")
	 ...
	 * Called between the throw and the catch
	 */
	@AfterThrowing(pointcut = "execution(* br.com.wamais.houseCare.controller..*Controller.*(..))", throwing = "e")
