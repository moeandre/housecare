...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "br.com.wamais.houseCare")
public class WebMVCConfiguration extends WebMvcConfigurerAdapter {
	...
	public SimpleMappingExceptionResolver exceptionResolver() {
		...
		exceptionMappings.put("br.com.wamais.houseCare.exception.UsuarioNaoEncontradoException", "forward:/403");
		exceptionMappings.put("br.com.wamais.houseCare.exception.SessaoExpiradaException", "forward:/401");
		...
		statusCodes.put("forward:/401", "401");
